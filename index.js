...
function btn() {
    ...
    $('#vats').html(Math.round((higtlight(s, h) / 100) / l) * l); //для светодиодных  для всех ламп
    ...
    $('#vats2').html(Math.round((higtlight(s, h) / 40) / l) * l); //для Люминесцентные  для всех ламп
    ...
    $('#vats3').html(Math.round((higtlight(s, h) / 10) / l) * l); //для накаливания   для всех ламп
